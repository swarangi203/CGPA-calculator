	...
	<body>
		<nav>
			<ul>			
				...
				$sub2=($grades[$_POST["FM"]]*3);
				$sub3=($grades[$_POST["BM"]]*3);
				$sub4=($grades[$_POST["EG"]]*2);
				$sub5=($grades[$_POST["ES"]]*3);
				$sub6=($grades[$_POST["SM"]]*3); 
				$sub7=($grades[$_POST["FMP"]]*1);
				$sub8=($grades[$_POST["BMP"]]*1);   
				$sub9=($grades[$_POST["EGP"]]*1);
				$sub10=($grades[$_POST["ESP"]]*1);
