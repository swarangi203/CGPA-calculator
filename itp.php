	...
	<body>
		<nav>
			<ul>			
				...
				$sub2=($grades[$_POST["DM"]]*4);
				$sub3=($grades[$_POST["DS"]]*3);
				$sub4=($grades[$_POST["MP"]]*3);
				$sub5=($grades[$_POST["DC"]]*3);
				$sub6=($grades[$_POST["CPP"]]*2);
				$sub7=($grades[$_POST["DSP"]]*1);
				$sub8=($grades[$_POST["MPP"]]*1);
				$sub9=($grades[$_POST["CPPP"]]*1);
