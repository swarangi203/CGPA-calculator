	...
	<body>
		<nav>
			<ul>			
				...
				$sub1=($grades[$_POST["PS"]]*4);
				$sub2=($grades[$_POST["ECA"]]*3);
				$sub3=($grades[$_POST["CT"]]*3);
				$sub4=($grades[$_POST["DE"]]*3);
				$sub5=($grades[$_POST["DSA"]]*1);
				$sub6=($grades[$_POST["SA"]]*3); 
				$sub7=($grades[$_POST["EAP"]]*1);
				$sub8=($grades[$_POST["ST"]]*1);   
				$sub9=($grades[$_POST["DEP"]]*1);
				$sub10=($grades[$_POST["MP"]]*1);
				$sub11=($grades[$_POST["DSAP"]]*3);
				$total=$sub1+$sub2+$sub3+$sub4+$sub5+$sub6+$sub7+$sub8+$sub9+$sub10+$sub11;
				$gtotal=$total/24;
