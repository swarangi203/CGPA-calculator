	...
	<body>
		<nav>
			<ul>			
				...
				$sub2=($grades[$_POST["T"]]*3);
				$sub3=($grades[$_POST["ME"]]*4);
				$sub4=($grades[$_POST["SM"]]*4);
				$sub5=($grades[$_POST["MP"]]*4);
				$sub6=($grades[$_POST["TP"]]*1);
				$sub7=($grades[$_POST["MEP"]]*1);   
				$sub8=($grades[$_POST["WP"]]*1);
